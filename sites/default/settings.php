...
// Default cache settings for all environments
$conf['cache'] = TRUE;
$conf['preprocess_css'] = TRUE;
$conf['preprocess_js'] = TRUE;
$conf['cache_lifetime'] = 60; // 1 minute
$conf['page_cache_maximum_age'] = 900; // 15 minutes
...
if (!defined('PANTHEON_ENVIRONMENT')) {
  // We're trying to deprecate local_settings.php in favor of settings.local.php
  // but don't want to break people's local sites.
  if (file_exists('./'. conf_path() .'/local_settings.php')) {
    include_once './'. conf_path() .'/local_settings.php';
  }
  elseif (file_exists('./'. conf_path() .'/settings.local.php')) {
    include_once './'. conf_path() .'/settings.local.php';
  }
}

$conf['locale_custom_strings_en'][''] = array(
   'Shopping cart updated.'      => 'Materials list updated.',
);
