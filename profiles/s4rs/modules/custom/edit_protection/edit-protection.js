(function($) {
  ...
  Drupal.behaviors.editProtection = {
    attach : function(context) {
      ...
      $(".node-form input[type='submit'], .entityform input[type='submit']").each(function() {
